...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'smart_city' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/james77/Desktop/SMS-Lab/Mid_term-Project/smart_city/install/lib;/home/james77/Desktop/SMS-Lab/Mid_term-Project/smart_city/devel/lib;/opt/ros/noetic/lib)
