...
(cl:defmethod cl:initialize-instance :after ((m <VehicleInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VehicleInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name smart_city-msg:<VehicleInfo> is deprecated: use smart_city-msg:VehicleInfo instead.")))

(cl:ensure-generic-function 'plate_number-val :lambda-list '(m))
(cl:defmethod plate_number-val ((m <VehicleInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smart_city-msg:plate_number-val is deprecated.  Use smart_city-msg:plate_number instead.")
  (plate_number m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <VehicleInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smart_city-msg:speed-val is deprecated.  Use smart_city-msg:speed instead.")
  (speed m))
